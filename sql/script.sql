...
insert into fixed.class(name, description, required_level, base_class)
VALUES ('🧙🏻‍♀️ Маг', 'Начинающий маг ученик.', 7, 1);
...
values
    (1, 2, 3, null, 'Ты побродил по руинам пару часов, было очень скучно.'),
    (2, 8, 10, 10, 'Ты обшарил старый заброшенный музей, тебе повезло найти *Энергетик 0.25*.'),
    (2, 8, 10, null, 'Ты обшарил старый заброшенный музей, там давно никто не убирался, но ничего кроме пары монет не нашел.');
